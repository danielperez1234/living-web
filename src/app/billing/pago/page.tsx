...
export default function Billing() {
  ...
  useEffect(() => {
    ...
    const loadScripts = async () => {
      ...
      openPayDataScript.src = "https://openpay.s3.amazonaws.com/openpay-data.v1.min.js";
  ...
  return (
    ...
    <div className="bkng-tb-cntnt">
        <div className="pymnts">
            <form action="#" method="POST" id="payment-form" ref={formRef}>
                ...
                <div className="pymnt-itm card active">
                    ...
                    <div className="pymnt-cntnt">
                        ...
                        <div className="sctn-row">
                                <button type="button" className="button rght" id="pay-button" ref={payButtonRef}>Pagar</button>
                        </div>
                    </div>
                </div>
            </form>
